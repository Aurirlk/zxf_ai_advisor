...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-3.0-darkgreen" alt="Version" />
...
curl -X POST http://127.0.0.1:8000/rag/ingest \
  -H "Content-Type: application/json" \
  -d '{"documents": [{"source": "2026_policy", "text": "..."}]}'

# 方式2: 编辑 JSON 后手动重建
# 编辑 data/vector_store/zx_experience.json
